...
if __name__=='__main__':
	...
	rects3 = ax.bar(ind+2*width, wfresult, width,color='red',ecolor='k')
	rects1 = ax.bar(ind, YosemiteResult, width,color='black',ecolor='k')
	rects2 = ax.bar(ind+width, VarysResult, width,color='blue',ecolor='k')
